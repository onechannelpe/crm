...
pub(super) fn run_ingest_phase(
    ...
    let merge_phase_stats = merge_ingest_session(config.db_path, session)
    ...
    let merge_email_secs = merge_phase_stats.email_secs;
