...
export function mapGpvRow(input: {
  ...
  return {
    ...
    row: {
      ...
      registeredSellerCode: cellTextOrNull(cells[GPV_COLUMNS.sellerCode]),
      registeredSellerName: cellTextOrNull(cells[GPV_COLUMNS.sellerName]),
      ...
      last15dGpv: cellNumberOrNull(cells[GPV_COLUMNS.last15dGpv]),
      last15dTrx: cellNumberOrNull(cells[GPV_COLUMNS.last15dTrx]),
