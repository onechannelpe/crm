...
export interface RegisterUploadInput {
  ...
  // Identifies this delivery. Re-posting the same label replaces that snapshot.
...
// Mirrors `pipeline::gate::GateCheck`.
...
export interface IngestJob {
  ...
  // On failure, this is the step that failed.
  step: IngestJobStep;
...
// Counters are null until staging has produced them.
