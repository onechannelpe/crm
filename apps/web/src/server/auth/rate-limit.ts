...
const authBucket = new TokenBucket<string>(10, 2);

export function consumeRateLimit(key: string, cost = 1): boolean {
  return authBucket.consume(key, cost);
}

export const passwordThrottler = new Throttler<string>([
  1, 2, 4, 8, 16, 30, 60, 180, 300,
]);

export const passkeyThrottler = new Throttler<string>([
  1, 2, 4, 8, 16, 30, 60, 180, 300,
]);
