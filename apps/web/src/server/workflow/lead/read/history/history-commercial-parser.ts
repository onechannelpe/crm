...
export function toRateProposedEntry(
  ...
  return Ok({
    ...
    payload: {
      proposalId: WorkflowRateProposalId.trust(proposalId.value),
      round: round.value,
...
export function toRateRevisionRequestedEntry(
  ...
  return Ok({
    ...
    payload: {
      revisionId: WorkflowRateRevisionId.trust(revisionId.value),
      round: round.value,
...
export function toVenueAddedEntry(
  ...
  return Ok({
    ...
    payload: {
      venueId: WorkflowVenueId.trust(venueId.value),
