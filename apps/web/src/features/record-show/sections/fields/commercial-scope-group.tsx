...
// The registration data (current provider, current rates, GPV, etc.) is the
// executive's own input and a frequent source of typos. It is correctable
// in place through the shared pencil primitive; visibility of each pencil is
// driven by the server-resolved edit-commercial-scope action, and every save
// routes through editCommercialScope so the audit trail and authz stay intact.
export function CommercialScopeGroup(props: { data: LeadDetailView }) {
