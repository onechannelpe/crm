...
export async function createRuntimePasses({
  geometry,
  imageFit,
  logicalHeight,
  logicalWidth,
...
export function resizeRuntimePasses({
  logicalHeight,
  logicalWidth,
  renderHeight,
  renderWidth,
  ...
  resources.sceneTarget.setSize(renderWidth, renderHeight);
  resources.transmissionBacksideTarget.setSize(renderWidth, renderHeight);
  resources.transmissionTarget.setSize(renderWidth, renderHeight);
  resources.blurTargetA.setSize(renderWidth, renderHeight);
  resources.blurTargetB.setSize(renderWidth, renderHeight);
  resources.blurHorizontalMaterial.uniforms.res.value.set(
    renderWidth,
    renderHeight,
  );
  resources.blurVerticalMaterial.uniforms.res.value.set(
    renderWidth,
    renderHeight,
  );
  resources.halftoneMaterial.uniforms.effectResolution.value.set(
    renderWidth,
    renderHeight,
  );
  resources.halftoneMaterial.uniforms.logicalResolution.value.set(
    logicalWidth,
    logicalHeight,
  );
  resources.imageMaterial.uniforms.viewportSize.value.set(
    logicalWidth,
    logicalHeight,
  );
}
