        ...
        <div class="min-h-screen grid items-center justify-center bg-gray-50/50 px-4">
            <div class="w-full max-w-100 space-y-8">
                ...
                <p class="text-xs text-center text-gray-400 px-8">
                    ...
                    <a href="https://policies.google.com/privacy" class="hover:underline mx-1">Política de privacidad</a>
                    y los
                    <a href="https://policies.google.com/terms" class="hover:underline mx-1">Términos del servicio</a>.
                </p>
            </div>
        </div>
    );
