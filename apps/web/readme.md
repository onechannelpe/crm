...
The engine contract is [`../../contracts/engine-api.json`](../../contracts/engine-api.json). Generated engine bindings are in [`src/server/shared/engine/contract.ts`](src/server/shared/engine/contract.ts).
