...
async function seedTemplate(db: Kysely<Database>) {
    ...
    await db.insertInto("organizations").values([
        { id: 1, ruc: "20100000001", name: "Org Lima", created_at: now, locked_branch_id: null, locked_at: null, locked_by_user_id: null },
        { id: 2, ruc: "20100000002", name: "Org Norte", created_at: now, locked_branch_id: null, locked_at: null, locked_by_user_id: null },
    ]).execute();
...
export async function createIsolatedTestDb(prefix: string): Promise<TestDbContext> {
