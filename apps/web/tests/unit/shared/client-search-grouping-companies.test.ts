...
describe("client search grouping companies", () => {
  ...
  it("does not merge entries when org_ruc is missing", () => {
    const groups = groupCompaniesByRuc([
      makeSearchRow({ dni: "11111111", name: "A", org_ruc: null, org_name: null, phone_primary: "999111111" }),
      makeSearchRow({ dni: "11111111", name: "A", org_ruc: null, org_name: null, phone_primary: "999111111" }),
    ]);
  ...
  it("aggregates and deduplicates emails per company", () => {
    const groups = groupCompaniesByRuc([
      makeSearchRow({ dni: "12345678", org_ruc: "20100000001", email: "juan@gmail.com" }),
      makeSearchRow({ dni: "87654321", org_ruc: "20100000001", email: "maria@hotmail.com" }),
      makeSearchRow({ dni: "12345678", org_ruc: "20100000001", email: "juan@gmail.com" }),
    ]);
