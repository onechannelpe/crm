...
describe("lead service quota invariants", () => {
  ...
  it("refunds consumed quota when persistence fails after assignment selection", async () => {
    ...
    vi.mocked(engineClient.search).mockResolvedValueOnce({
      ...
      results: [
        {
          person: { dni: "70010001", name: "Contacto Caido", birth_date: null, birth_place: null, sex: null, marital_status: null, location_text: null, ubigeo_code: null, mother_name: null, father_name: null, email: null, ruc: null },
          org: { ruc: "20100000001", name: "Org Lima", trade_name: null, company_type: null, status: null, condition: null, fiscal_address: null, registration_date: null, activity_start_date: null, line_of_business: null, economic_activity: null },
          role: null,
